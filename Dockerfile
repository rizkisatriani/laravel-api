FROM php:7.3-apache
MAINTAINER Rizki Agung <agungrizki0@gmail.com>
...
COPY artisan /var/www/xdemia/main
RUN chmod 0755 /var/www/xdemia/main/artisan
...
RUN mkdir -p /var/www/xdemia/main/public
RUN chown -R www-data: /var/www
#RUN a2enmod ssl
#RUN a2ensite default-ssl
RUN sed -i -e "s/html/xdemia\/main\/public/g" /etc/apache2/sites-enabled/000-default.conf
